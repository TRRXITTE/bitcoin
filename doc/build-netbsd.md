...
traaittXT Enterprise includes a GUI built with the cross-platform Qt Framework. To compile the GUI, we need to install `qt5`.
...
There are many ways to configure traaittXT Enterprise. Here is an example that
