UNIX BUILD NOTES
====================
Some notes on how to build traaittXT Enterprise in Unix.
...
memory available when compiling traaittXT Enterprise. On systems with less, gcc can be
...
To build traaittXT Enterprise without wallet, see [*Disable-wallet mode*](#disable-wallet-mode)
...
Disable-wallet mode
--------------------
When the intention is to only run a P2P node, without a wallet, traaittXT Enterprise can
