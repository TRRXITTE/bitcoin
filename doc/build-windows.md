...
Below are some notes on how to build traaittXT Enterprise for Windows.

The options known to work for building traaittXT Enterprise on Windows are:
...
Note that for WSL the traaittXT Enterprise source path MUST be somewhere in the default mount file system, for
