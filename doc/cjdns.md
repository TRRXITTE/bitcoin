# CJDNS support in traaittXT Enterprise

It is possible to run traaittXT Enterprise over CJDNS, an encrypted IPv6 network that
...
done outside of traaittXT Enterprise, similarly to a VPN (either in the host/OS or on
...
before it will work with your traaittXT Enterprise node. This is described in steps
...
## Run traaittXT Enterprise with CJDNS

Once you are connected to the CJDNS network, the following traaittXT Enterprise
...
When enabled, this option tells traaittXT Enterprise that it is running in an
...
IPv6 local network. This helps traaittXT Enterprise perform better address management:
...
CJDNS support was added to traaittXT Enterprise in version 23.0 and there may be fewer
...
## CJDNS-related information in traaittXT Enterprise

There are several ways to see your CJDNS address in traaittXT Enterprise:
