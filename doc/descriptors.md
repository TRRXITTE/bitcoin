# Support for Output Descriptors in traaittXT Enterprise

Since traaittXT Enterprise v0.17, there is support for Output Descriptors. This is a
...
transactions related to the multisig. Lastly, it is not recommended to use anything other than a traaittXT Enterprise descriptor wallet to serve as your
...
existing traaittXT Enterprise wallets, a convenience function `combo` is
...
All RPCs in traaittXT Enterprise will include the checksum in their output. Only
