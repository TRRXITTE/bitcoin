When traaittXT Enterprise automatically opens outgoing P2P connections, it chooses
...
and usually require authentication. A connection attempt (by traaittXT Enterprise,
...
Below is a list of "bad" ports which traaittXT Enterprise avoids when choosing a peer to
