traaittXT Enterprise version 0.11.0 is now available from:
...
defaults to 0.00001. This will cause transactions with fewer XTEcash/kB fee to be
...
Block pruning allows traaittXT Enterprise to delete the raw block and undo data once 
...
block index and UTXO databases. The minimum was chosen so that traaittXT Enterprise will 
