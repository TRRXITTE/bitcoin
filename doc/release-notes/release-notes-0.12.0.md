<<<<<<< HEAD
traaittXT version 0.12.0 is now available from:
=======
...
<<<<<<< HEAD
backwards-compatible with pre-0.10 versions of traaittXT or other software:
=======
...
<<<<<<< HEAD
pre-0.12 versions of traaittXT or other software.

If you want to downgrade after you have done a reindex with 0.12.0 or later,
you will need to reindex when you first start traaittXT version 0.11 or
=======
...
<<<<<<< HEAD
Previous versions of traaittXT had their mempool limited by checking
=======
...
<<<<<<< HEAD
for previous versions of traaittXT was to raise the default minimum
relay fee.

traaittXT 0.12 will have a strict maximum size on the mempool. The
=======
...
<<<<<<< HEAD
traaittXT 0.12 also introduces new default policy limits on the length and
=======
...
<<<<<<< HEAD
traaittXT 0.12 nodes. traaittXT will only allow replacement of
=======
...
<<<<<<< HEAD
Note that the wallet in traaittXT 0.12 does not yet have support for
=======
...
<<<<<<< HEAD
traaittXT has a heuristic 'priority' based on coin value and age. This
calculation is used for relaying of transactions which do not pay the
minimum relay fee, and can be used as an alternative way of sorting
transactions for mined blocks. traaittXT will relay transactions with
insufficient fees depending on the setting of `-limitfreerelay=<r>` (default:
`r=15` kB per minute) and `-blockprioritysize=<s>`.

In traaittXT 0.12, when mempool limit has been reached a higher minimum
=======
...
<<<<<<< HEAD
entirely in traaittXT 0.13, and it is at this time undecided whether the
=======
...
<<<<<<< HEAD
traaittXT has been updated to make use of this.

This means that if Tor is running (and proper authorization is available),
traaittXT automatically creates a hidden service to listen on, without
manual configuration. traaittXT will also use Tor automatically to connect
to other .onion nodes if the control socket can be successfully opened. This
will positively affect the number of available .onion nodes and their usage.

This new feature is enabled by default if traaittXT is listening, and
=======
...
<<<<<<< HEAD
Core to use floating fees. By default, traaittXT will use floating
=======
...
<<<<<<< HEAD
At all times, traaittXT will cap fees at `-maxtxfee=<x>` (default:
0.10) XTEcash.
Furthermore, traaittXT will never create transactions paying less than
=======
