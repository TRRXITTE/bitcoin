traaittXT Enterprise version 0.13.0 is now available from:
...
In addition to that, with 0.12.x there have been varied reports of traaittXT Enterprise
...
Various code modernizations have been done. The traaittXT Enterprise code base has
...
HD wallets are incompatible with older versions of traaittXT Enterprise.
...
proposed parameters, a future release of traaittXT Enterprise is expected that
...
- #8153 `75ec320` `fundrawtransaction` feeRate: Use XTEcash/kB (MarcoFalke)
