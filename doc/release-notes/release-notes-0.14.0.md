traaittXT Enterprise version 0.14.0 is now available from:
...
traaittXT Enterprise is extensively tested on multiple operating systems using
...
traaittXT Enterprise has supported automatically pruning the blockchain since 0.11. Pruning
...
When traaittXT Enterprise is out-of-sync on startup, a semi-transparent information
...
The Alert System was [disabled and deprecated](https://bitcoin.org/en/alert/2016-11-01-alert-retirement) in traaittXT Enterprise 0.12.1 and removed in 0.13.0. 
...
----------------------
 ...
 - A new RPC command `getmemoryinfo` has been added which will return information
   about the memory usage of traaittXT Enterprise. This was added in conjunction with
...
### Documentation
- #8400 `806b9e7` Clarify witness branches in transaction.h serialization (dcousens)
