traaittXT Enterprise version *0.15.1* is now available from:
...
A number of changes to the way traaittXT Enterprise deals with peer connections and invalid blocks
