traaittXT Enterprise version 0.9.0 is now available from:
...
Rebranding to traaittXT Enterprise
---------------------------

To reduce confusion between Bitcoin-the-network and Bitcoin-the-software we
have renamed the reference client to traaittXT Enterprise.
...
- Rebrand to `traaittXT Enterprise`
