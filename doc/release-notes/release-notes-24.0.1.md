...
traaittXT Enterprise version 24.0.1 is now available from:
...
This version of traaittXT Enterprise adds a new `mempoolfullrbf` configuration
...
fees, was realized in [traaittXT Enterprise 0.12.0][] (February 2016) with the
...
default for years, and several contributors to traaittXT Enterprise are
...
[traaittXT Enterprise 0.12.0]: https://bitcoincore.org/en/releases/0.12.0/#opt-in-replace-by-fee-transactions
...
- The `wsh()` output descriptor was extended with Miniscript support. You can import Miniscript
  ...
  the traaittXT Enterprise wallet yet.
...
- To help prevent fingerprinting transactions created by the traaittXT Enterprise wallet, change output
