...
your bitcoind's P2P listen port (8334 by default), and target addresses and ports
...
and open port 8334 on your firewall (or use port mapping, i.e., `-upnp` or `-natpmp`).
