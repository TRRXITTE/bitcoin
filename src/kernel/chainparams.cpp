...
{
    const char* pszTimestamp = "tBTC 18th August 2024";
...
public:
    CMainParams() {
        ...
        consensus.BIP65Height = 1; // 0000a95e08d4984c3e944263097ea0062566c916d0f6d71b34a06789ac6c4f5f
        consensus.BIP66Height = 1; // 0000a95e08d4984c3e944263097ea0062566c916d0f6d71b34a06789ac6c4f5f
        consensus.CSVHeight = 1; // 0000a95e08d4984c3e944263097ea0062566c916d0f6d71b34a06789ac6c4f5f
        consensus.SegwitHeight = 0; // 0000a95e08d4984c3e944263097ea0062566c916d0f6d71b34a06789ac6c4f5f
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].nStartTime = 1724001017; // instant
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].nTimeout = 1724001017; // instant
        consensus.vDeployments[Consensus::DEPLOYMENT_TAPROOT].min_activation_height = 1; // instant
        ...
        // Updated genesis block parameters
        genesis = CreateGenesisBlock(1724001017, 86921, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0000a95e08d4984c3e944263097ea0062566c916d0f6d71b34a06789ac6c4f5f"));
        assert(genesis.hashMerkleRoot == uint256S("0x4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"));

        vSeeds.clear();
        vSeeds.emplace_back("eu.trrxitte.com");
        vSeeds.emplace_back("eu-west.trrxitte.com");
