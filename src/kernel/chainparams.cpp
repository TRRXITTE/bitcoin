...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1743436800, 2084274001, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256{"00000484c46425cb3b260b4ecc3c33f032bf8bc8396eca605309696e4c361516"});
        assert(genesis.hashMerkleRoot == uint256{"3b91683bea9b73100e013a7a1af2c9c824f79157d81bf9f63cb25fc41f4d29fe"});
        ...
        checkpointData = {
            {
                {0, uint256{"00000484c46425cb3b260b4ecc3c33f032bf8bc8396eca605309696e4c361516"}},
            }
        };
...
public:
    CTestNetParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256{"0002227d24b38c135f8bce914525e47f90e572e83fe5691bb22f3af9ef9347bf"});
        assert(genesis.hashMerkleRoot == uint256{"3b91683bea9b73100e013a7a1af2c9c824f79157d81bf9f63cb25fc41f4d29fe"});
...
public:
    explicit SigNetParams(const SigNetOptions& options)
    {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256{"00000f67fafd0690c9aefe7c250d1cfad33f82f64f6d188e47f0608adc4db40c"});
        assert(genesis.hashMerkleRoot == uint256{"3b91683bea9b73100e013a7a1af2c9c824f79157d81bf9f63cb25fc41f4d29fe"});
