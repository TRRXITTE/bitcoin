This directory contains the source code for the traaittXT Enterprise graphical user interface (GUI). It uses the [Qt](https://www1.qt.io/developers/) cross-platform framework.
...
* `bitcoinunits.(h/cpp)`: XTEcash / mBTC / etc. handling
* `callback.h`
...
9. You're all set! Start developing, building, and debugging the traaittXT Enterprise GUI
