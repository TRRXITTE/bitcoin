...
BOOST_AUTO_TEST_CASE(patharg)
{
    ...
    const fs::path absolute_path{"/home/user/.TRRXITTE"};
    ResetArgs(local_args, "-dir=/home/user/.TRRXITTE");
    BOOST_CHECK_EQUAL(local_args.GetPathArg("-dir"), absolute_path);

    ResetArgs(local_args, "-dir=/root/../home/user/.TRRXITTE");
    BOOST_CHECK_EQUAL(local_args.GetPathArg("-dir"), absolute_path);
    ...
    const fs::path relative_path{"user/.TRRXITTE"};
    ResetArgs(local_args, "-dir=user/.TRRXITTE");
    BOOST_CHECK_EQUAL(local_args.GetPathArg("-dir"), relative_path);

    ResetArgs(local_args, "-dir=somewhere/../user/.TRRXITTE");
    BOOST_CHECK_EQUAL(local_args.GetPathArg("-dir"), relative_path);
