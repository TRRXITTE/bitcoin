...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 TRRXITTE from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 TRRXITTE with subtract fee from amount
        ...
        # Sendmany 10 TRRXITTE with subtract fee from amount
        ...
        # Sendmany 5 TRRXITTE to two addresses with subtracting fee from both addresses
