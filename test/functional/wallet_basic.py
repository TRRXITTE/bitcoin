...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 XTEcash from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 XTEcash with subtract fee from amount
        ...
        # Sendmany 10 XTEcash with subtract fee from amount
        ...
        # Sendmany 5 XTEcash to two addresses with subtracting fee from both addresses
