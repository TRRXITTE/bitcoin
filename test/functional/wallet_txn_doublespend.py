...
class TxnMallTest(BitcoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 XTEcash:
        ...
        # First: use raw transaction API to send 1240 XTEcash to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 XTEcash coin each
